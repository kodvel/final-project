...
Superseded in part: `packages/contracts` was retired for the MVP because frontend and backend use different languages. Backend FastAPI/Pydantic/SQLModel schemas are the validation source of truth, and frontend TypeScript types live locally in `apps/web/src/types`.
...
- Initially use `packages/contracts` as a placeholder for shared API, RAG, and agent contracts.
